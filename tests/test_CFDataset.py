...
@mark.parametrize('tiny_dataset, prop, expected', [
    ...
    ('cmip6', 'first_MiB_md5sum', 'ffb44f7cadaa08d880a983d81d539576'),
    ('cmip6', 'md5', 'ffb44f7cadaa08d880a983d81d539576'),
    ('cmip6', 'climatology_bounds_var_name', None),
    ('cmip6', 'sampling_geometry', 'gridded'),
    ('cmip6', 'is_multi_year', False),
    ('cmip6', 'is_multi_year_mean', False),
    ('cmip6', 'time_range', (36524.5, 36554.5)),
    ('cmip6', 'time_resolution', 'daily'),
    ('cmip6', 'is_unprocessed_gcm_output', False),
    ('cmip6', 'is_downscaled_output', True),
    ('cmip6', 'is_hydromodel_output', False),
    ('cmip6', 'is_hydromodel_dgcm_output', False),
    ('cmip6', 'is_hydromodel_iobs_output', False),
    ('cmip6', 'is_streamflow_model_output', False),
    ('cmip6', 'is_streamflow_model_dgcm_output', False),
    ('cmip6', 'is_streamflow_model_iobs_output', False),
    ('cmip6', 'is_climdex_output', False),
    ('cmip6', 'is_climdex_ds_gcm_output', False),
    ('cmip6', 'is_gridded_obs', False),
    ('cmip6', 'model_type', 'GCM'),
    ('cmip6', 'ensemble_member', 'r1i1p1f1'),
    ('cmip6', 'cmor_filename',
