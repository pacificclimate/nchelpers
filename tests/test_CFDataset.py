...
@mark.parametrize('tiny_dataset, prop, expected', [
    ...
    ('cmip6_downscaled', 'first_MiB_md5sum', 'ffb44f7cadaa08d880a983d81d539576'),
    ('cmip6_downscaled', 'md5', 'ffb44f7cadaa08d880a983d81d539576'),
    ('cmip6_downscaled', 'climatology_bounds_var_name', None),
    ('cmip6_downscaled', 'sampling_geometry', 'gridded'),
    ('cmip6_downscaled', 'is_multi_year', False),
    ('cmip6_downscaled', 'is_multi_year_mean', False),
    ('cmip6_downscaled', 'time_range', (36524.5, 36554.5)),
    ('cmip6_downscaled', 'time_resolution', 'daily'),
    ('cmip6_downscaled', 'is_unprocessed_gcm_output', False),
    ('cmip6_downscaled', 'is_downscaled_output', True),
    ('cmip6_downscaled', 'is_hydromodel_output', False),
    ('cmip6_downscaled', 'is_hydromodel_dgcm_output', False),
    ('cmip6_downscaled', 'is_hydromodel_iobs_output', False),
    ('cmip6_downscaled', 'is_streamflow_model_output', False),
    ('cmip6_downscaled', 'is_streamflow_model_dgcm_output', False),
    ('cmip6_downscaled', 'is_streamflow_model_iobs_output', False),
    ('cmip6_downscaled', 'is_climdex_output', False),
    ('cmip6_downscaled', 'is_climdex_ds_gcm_output', False),
    ('cmip6_downscaled', 'is_gridded_obs', False),
    ('cmip6_downscaled', 'model_type', 'GCM'),
    ('cmip6_downscaled', 'ensemble_member', 'r1i1p1f1'),
    ('cmip6_downscaled', 'cmor_filename',
     'pr_day_BCCAQv2_MPI-ESM1-2-HR_historical+ssp126_r1i1p1f1_19500101-19500131_Canada.nc'),
    ('cmip6_downscaled', 'unique_id',
     'pr_day_BCCAQv2_MPI-ESM1-2-HR_historical-ssp126_r1i1p1f1_19500101-19500131_Canada'),
